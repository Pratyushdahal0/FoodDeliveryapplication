...
function renderCart() {
  ...
  // 🔥 IMPORTANT FIX: include restaurant_id in buttons
  cartItemsList.innerHTML = items
    ...
    <div class="cart-item">
      ...
      <div class="cart-item-quantity">
        <button class="qty-btn" onclick="changeQuantity(${item.id}, ${
        item.restaurant_id
      }, -1)">−</button>
...
function changeQuantity(productId, restaurantId, delta) {
  ...
  const item = items.find(
    (i) =>
      ...
      String(i.restaurant_id) === String(restaurantId)
  );
...
function proceedToCheckout() {
  ...
  // 🔥 IMPORTANT: ensure restaurant_id is included
  ...
  // store everything for checkout page
